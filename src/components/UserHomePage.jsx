...
function UserHomePage() {
    ...
    return (
        <div className={`user-homepage-container ${darkMode ? 'dark-mode' : ''}`}>
            <UserHeader
                darkMode={darkMode}
            ...
            {/* Hero Section */}
            <div className="user-homepage-hero">
                ...
                <div className="user-homepage-buttons">
                    <Link to="/product"><button className="user-homepage-btn">Shop Now</button></Link>
                    <Link to="/about"><button className="user-homepage-btn secondary">Learn More</button></Link>
                </div>
            </div>
            ...
            <div className="user-homepage-search">
                ...
                />
                <button className="user-homepage-search-btn">Search</button>
            </div>

            {/* Interactive Categories */}
            <div className="user-homepage-categories">
                <h2>Explore Categories</h2>
                <div className="user-categories-grid">
                    {Object.keys(categoryContent).map((category) => (
                        <div
                            key={category}
                            className={`user-category-card ${activeCategory === category ? 'active' : ''}`}
            ...
            {/* Offers Carousel */}
            <div className="user-homepage-offers">
            ...
            <div className="user-homepage-testimonials">
                <h2>Customer Testimonials</h2>
                <div className="user-testimonials-slider">
            ...
            {/* Blog Teaser */}
            <div className="user-homepage-blog" id="blog">
                <h2>Read Our Blog</h2>
                <div className="user-blog-preview">
                    <div className="user-blog-card">
                        ...
                        <button className="user-blog-btn">Read More</button>
                    </div>
                    <div className="user-blog-card">
            ...
            <div className="user-homepage-impact">
                <h2>Our Sustainability Impact</h2>
                <p>Waste Reduced: <span className="user-count-up">1,234 kg</span></p>
                <p>Containers Recycled: <span className="user-count-up">1 Million</span></p>
            </div>

            {/* Countdown Timer for Special Offer */}
            <div className="user-countdown-timer">
                <h3>Special Offer - Ends In:</h3>
                <div id="user-countdown"></div>
            </div>

            {/* Sticky Announcement Bar */}
            <div className="user-sticky-announcement">
                <p>New Arrivals! Check out our latest eco-friendly products!</p>
            </div>

            {/* Newsletter Signup */}
            <div className="user-homepage-newsletter">
                <h2>Stay Connected</h2>
                <p>Subscribe to our newsletter for updates and offers.</p>
                <div className="user-newsletter-form">
                    <input type="email" placeholder="Enter your email" />
                    <button className="user-newsletter-btn">Subscribe</button>
                </div>
            </div>
        </div>
    );
